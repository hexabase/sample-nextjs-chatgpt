...
import type { ChatMessage, OpenAIChatMessage, ChatMessageParams, OpenAIStreamingParams, OpenAIChatRole } from "./types";
...
export const useChatCompletion = (apiParams: OpenAIStreamingParams) => {
  ...
  return { messages, loading, submitPrompt, abortResponse, resetMessages, setMessages };
};
